...
本 V2 PRD 已获得用户批准，并已替代 V1“战略性新兴产业扶持、无企业主体”的产品契约。代码、测试、数据、API 和 React 前端已经按本契约完成原地迁移；V1 回滚点保留在 Git 提交 `6ea8e9d`。
...
产品 QA 已通过。公开发布仍须遵守 `apps/web/src/assets/maps/README.md` 中的标准地图合规人工复核门禁；该门禁不改变当前本地产品的功能验收结论。
